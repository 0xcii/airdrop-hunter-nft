...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col bg-gradient-to-br overflow-hidden">
      <Head>
        ...
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          ...
          <Link href="#">
            <a className="font-coiny text-xl md:text-3xl font-bold">
              ...
              <span className="bg-brand-light from-brand-blue to-brand-purple pr-2 bg-clip-text text-transparent ">
                Hunter
              </span>
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-4 md:space-x-6">
              <li className="cursor-pointer">
                <a href="https://opensea.io" target="_blank" rel="noreferrer" style={{ color: 'white' }}>
                  <svg
      ...
      <div className="h-full w-full container max-w-5xl mx-auto flex flex-col items-center pt-4">
        <div className="flex flex-col items-center max-w-4xl w-full">
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full">
            ...
            <div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-brand-light px-4 md:px-0 py-10 mt-14">
